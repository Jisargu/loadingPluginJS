...
(function($) {
	...
	var _en = {
		defaultError : {
			content : "Imagino al destripador como uno de esos seres que nacen en los hospitales, lo alimentan, lo mantienen caliente pero no hacen mucho más por él. Lo dejan morir, pero no se muere. Él parece normal, pero nadie sabría decir lo que es",
			author : "Will Graham",
			origin : "Red Dragon",
		},
